...
function initEvents()
	...
	EventManager:registerEventHandler( Event.Enter_Expert_History, "scripts.actions.EnterExpertHistoryAction" )
	...
	EventManager:registerEventHandler( Event.Load_More_In_Expert_History, "scripts.actions.LoadMoreInExpertHistoryAction" )
