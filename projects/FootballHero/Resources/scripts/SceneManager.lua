...
local EnterPushNotificationAction = require("scripts.actions.EnterPushNotificationAction")
local EnterShareAction = require("scripts.actions.EnterShareAction")
...
local DoPostPNUserSettingAction = require("scripts.actions.DoPostPNUserSettingAction")
local DoPostPNCompetitionSettingAction = require("scripts.actions.DoPostPNCompetitionSettingAction")
...
local DoLeaveCompetitionAction = require("scripts.actions.DoLeaveCompetitionAction")
...
local DoPostDeviceTokenAction = require("scripts.actions.DoPostDeviceTokenAction")
local DoGetChatMessageAction = require("scripts.actions.DoGetChatMessageAction")
local DoShareBySMSAction = require("scripts.actions.DoShareBySMSAction")
local DoShareByEmailAction = require("scripts.actions.DoShareByEmailAction")
...
local ShowPleaseUpdateAction = require("scripts.actions.ShowPleaseUpdateAction")
...
function initEvents()
	...
	EventManager:registerEventHandler( Event.Enter_Push_Notification, EnterPushNotificationAction )
	...
	EventManager:registerEventHandler( Event.Enter_Share, EnterShareAction )
	...
	EventManager:registerEventHandler( Event.Do_Post_PN_User_Settings, DoPostPNUserSettingAction )
	EventManager:registerEventHandler( Event.Do_Post_PN_Comp_Settings, DoPostPNCompetitionSettingAction )
	EventManager:registerEventHandler( Event.Do_Post_Device_Token, DoPostDeviceTokenAction )
	...
	EventManager:registerEventHandler( Event.Do_Leave_Competition, DoLeaveCompetitionAction )
	...
	EventManager:registerEventHandler( Event.Do_Share_By_SMS, DoShareBySMSAction )
	EventManager:registerEventHandler( Event.Do_Share_By_Email, DoShareByEmailAction )
	...
	EventManager:registerEventHandler( Event.Show_Please_Update, ShowPleaseUpdateAction )
