...
GET_UPCOMING_TODAY = SERVER_IP.."/api/games/upcomingToday"
GET_UPCOMING_NEXT = SERVER_IP.."/api/games/upcomingNext"
...
GET_MATCH_CENTER = SERVER_IP.."/api/games/matchCenter"
GET_SETTINGS = SERVER_IP.."/api/user/settingsPage"
...
function setServerIP( serverIp, cdnServerIp, useDev )
    ...
    GET_MATCH_CENTER = serverIp.."/api/games/matchCenter"
    GET_SETTINGS = serverIp.."/api/user/settingsPage"
