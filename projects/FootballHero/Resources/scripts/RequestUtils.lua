...
YUUZOO_LOGIN_REST_CALL = SERVER_IP.."/api/user/signupWithYuuzoo"
...
GET_MAIN_PREMIUMBOARD_REST_CALL = SERVER_IP.."/api/leaderboards/getPremiumLeaderboard"
...
GET_COMPETITION_FOLLOW_REST_CALL = SERVER_IP.."/api/couponhistory/getFollowsAndFollowing"
GET_FOLLOW_EXPERTS = SERVER_IP.."/api/teamexperts/followorUnfollwExperts"
GET_TIMELINE = SERVER_IP.."/api/Timelines/getTimeline"
...
function setServerIP( serverIp, cdnServerIp, useDev )
    ...
    YUUZOO_LOGIN_REST_CALL = serverIp.."/api/user/signupWithYuuzoo"
    ...
    GET_MAIN_PREMIUMBOARD_REST_CALL = serverIp.."/api/leaderboards/getPremiumLeaderboard"
    ...
    GET_COMPETITION_FOLLOW_REST_CALL = serverIp.."/api/couponhistory/getFollowsAndFollowing"
    GET_FOLLOW_EXPERTS = serverIp.."/api/teamexperts/followorUnfollwExperts"
    GET_TIMELINE_REST_CALL = serverIp.."/api/Timelines/getTimeline"
