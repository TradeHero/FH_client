...
ShareContent = {
	...
	{	["id"] = SHARE_COMPETITION.."americacup2016", 
		["content"] = Constants.String.share.competition_americacup2016_content,
		["image"] = "http://fhmainstorage.blob.core.windows.net/fhres/fb-share-americacup2016.png",
		["title"] = Constants.String.share.competition_title,
		["description"] = Constants.String.football_hero,
		["url"] = "http://www.sportshero.mobi",
		["type"] = C2DXContentTypeNews,
