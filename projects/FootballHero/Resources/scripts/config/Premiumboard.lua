...
LeaderboardType = {
  { ["displayNameKey"] = "top_performers", ["logo"] = Constants.LEADERBOARD_IMAGE_PATH.."top-performers.png", ["request"] = RequestUtils.GET_MAIN_PREMIUMBOARD_REST_CALL },
  
--[[
  { ["displayNameKey"] = "friends", ["logo"] = Constants.LEADERBOARD_IMAGE_PATH.."friends.png", ["request"] = RequestUtils.GET_MAIN_PREMIUMBOARD_REST_CALL },
