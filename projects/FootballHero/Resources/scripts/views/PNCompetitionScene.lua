...
function loadFrame( selectYesCallback, selectNoCallback )
    ...
    lbQuestion:setText( Constants.String.push_notification.question_competition )
    lbBody1:setText( Constants.String.push_notification.receive )
    lbBody2:setText( Constants.String.push_notification.new_participant )
    lbBody3:setText( Constants.String.push_notification.prediction_summary )
