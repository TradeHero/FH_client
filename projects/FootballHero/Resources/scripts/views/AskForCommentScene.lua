...
function loadFrame()
    ...
    yesBt:setTitleText( Constants.String.button.ok )
    noBt:setTitleText( Constants.String.button.no_thanks )
    msg1:setText( Constants.String.info.leave_comment1 )
    msg2:setText( Constants.String.info.leave_comment2 )
