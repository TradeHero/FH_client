...
StringsDefault = {
  ...
  friends = "Friends",
  handicap = {
    h0_home = "You win if %s wins.\nYour bet is refunded on a draw.",
    h0_away = "You win if %s wins.\nYour bet is refunded on a draw.",
    h0_25_home = "You win if %s wins.\nYou lose half your bet if %s draws.",
    h0_25_away = "You win if %s wins.\nYou win half your bet if %s draws.",
    h0_5_home = "You win if %s wins.",
    h0_5_away = "you win if %s wins or draws.",
    h0_75_home = "You win if %s wins by 2 goals or more.\nYou win half your bet if %s wins by 1 goal.",
    h0_75_away = "You win if %s wins or draws.\nYou lose half your bet if %s loses by 1 goal.",
    h1_home = "You win if %s wins by 2 goals or more.\nYour bet is refunded if %s wins by 1 goal.",
    h1_away = "You win if %s wins or draw.\nYour bet is refunded if %s loses by 1 goal.",
    h1_25_home = "You win if %s wins by 2 goals or more.\nYou lose half your bet if %s wins by 1 goal.",
    h1_25_away = "You win if %s draws or wins.\nYou win half your bet if %s loses by 1 goal.",
    h1_5_home = "You win if %s wins by 2 goals or more.",
    h1_5_away = "You win if %s wins, draw or loses by 1 goal.",
    h1_75_home = "You win if %s wins by 3 goals or more.\nYou win half your bet if %s wins by 2 goal.",
    h1_75_away = "You win if %s wins or draw.\nYou lose half your bet if %s loses by 2 goals.",
    h2_home = "You win if %s wins by 3 goals or more.\nYour bet is refunded if %s wins by 2 goals.",
    h2_away = "You win if %s wins, draws or loses by 1 goal.\nYour bet is refunded if %s loses by 2 goals.",
    h2_25_home = "You win if %s wins by 3 goals or more.\nYou lose half your bet if %s wins by 2 goals.",
    h2_25_away = "You win if %s wins, draws or loses by 1 goal.\nYou win half your bet if %s loses by 2 goals.",
    h2_5_home = "You win if %s wins by 3 goals or more.",
    h2_5_away = "You win if %s wins, draws or loses by 2 goals or less.",
    h2_75_home = "You win if %s wins by 4 goals or more.\nYou win half your bet if %s win by 3 goals.",
    h2_75_away = "You win if %s wins, draws or loses by 2 goals or less.\nYou lose half your bet if %s loses by 3 goals.",
    h3_home = "You win if %s wins by 4 goals or more.\nYour bet is refunded if %s wins by 3 goals.",
    h3_away = "You win if %s wins, draws or loses by 2 goals or less.\nYour bet is refunded if %s loses by 3 goals.",
    h3_25_home = "You win if %s wins by 4 goals or more.\nYou lose half your bet if %s wins by 3 goals.",
    h3_25_away = "You win if $s wins, draws or loses by 2 goals or less.\nYou win half your bet if %s loses by 3 goals.",
    h3_5_home = "You win if %s wins by 4 goals or more.",
    h3_5_away = "You win if %s wins, draws or loses by 3 goals or less.",
    h3_75_home = "You win if %s wins by 5 goals or more.\nYou win half your bet if %s win by 4 goals.",
    h3_75_away = "You win if %s wins, draws or loses by 3 goals or less.\nYou lose half your bet if %s loses by 4 goals.",
    h4_home = "You win if %s wins by 5 goals or more.\nYour bet is refunded if %s wins by 4 goals.",
    h4_away = "You win if %s wins, draws or loses by 3 goals or less.\nYour bet is refunded if %s loses by 4 goals.",
    name = "Asian Handicap",
