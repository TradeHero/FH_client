...
StringsDefault = {
  ...
  community = {
    ...
    title_pleaderboard = "Premium Leaderboard",
  ...
  lucky8 = {
    ...
    lucky8_sub_des   = "Predict random 8 games daily and win $250 if you guess all 8 matches correctly!",
  ...
  spinWheel = {
    ...
    win_ticket_prize = "Lucky Draw Ticket",
  ...
  share_body = "Can you beat me? Join my competition on SportsHero. Code: %s  www.sportshero.mobi/download",
  ...
  vs = "VS",
  share = {
    spinTheWheel_content = "I won a prize in Spin-The-Wheel game! Win $$$, Messi & Ronaldo Signed Jerseys! www.sportshero.mobi/download",
    competition_content = "I joined a SportsHero Prediction competition. Win $$$, Messi & Ronaldo Signed Jerseys! www.sportshero.mobi/download",
    ...
    predResult_content = "SportsHero: %s\nCLICK HERE TO PLAY! www.sportshero.mobi/download",
    video_content = "%s.\nCLICK HERE TO WATCH! www.sportshero.mobi/download",
