...
Strings = {
	...
	spinWheel = {
		...
		share_description = "Bagikan ke teman Anda dan dapatkan putaran tambahan.",
		wheel_sub_title = "Spin-the-Wheel!",
		win_ticket_prize = "Tiket Lucky Draw",
		balance_title = "Saldo",
		come_back_in = "Kembali lagi dalam:",
		...
		collect_email_towards_wallet = "terhadap saldo rekening Anda",
		collect_email_prize = "1 Dolar US",
		collect_email_description = "Silahkan masukkan alamat email yang benar. Alamat email yang palsu akan di diskualifikasi dari hadiah.",
	},
	...
	email_confirm = "Alamat Email telah dikonfirmasi",
	match_prediction = {
